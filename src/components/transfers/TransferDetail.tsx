...
// import { Tabs, Table, Input, Tag, Button,Form, Modal,InputNumber,message } from "antd";
// import type { TabsProps, TableProps } from "antd";
// import type { TransferItem ,UpdateTransferPayload} from "@/types/transfer";
...
//   const { detail, getById, deleteTransfer, getAll,updateTransfer } = useTransferStore();
...
//       const result = await updateTransfer(detail.id, payload);
//       if (result.success) {
